...
class OrderSearchForm(Form):
    ...
    apply_put_id = StringField('Apply Put Id')      # 申请投资Id
    apply_get_id = StringField('Apply Get Id')      # 申请提现Id
    apply_put_uid = StringField('Apply Put Uid')    # 申请投资用户Id
    apply_get_uid = StringField('Apply Get Uid')    # 申请提现用户Id
    ticket_put_id = StringField('Ticket Put Id')    # 付款单Id
    ticket_get_id = StringField('Ticket Get Id')    # 收款单Id
